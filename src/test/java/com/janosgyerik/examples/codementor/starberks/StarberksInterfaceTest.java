...
public class StarberksInterfaceTest {

    private final StarberksInterface starberks = new StarberksInterface();

    @Test
    public void isValidProductName_should_return_true_for_length_3() {
        assertTrue(starberks.isValidProductName("abc"));
    }

    @Test
    public void isValidProductName_should_return_true_for_length_10() {
        assertTrue(starberks.isValidProductName("0123456789"));
    }

    @Test
    public void isValidProductName_should_return_false_for_length_below_3() {
        assertFalse(starberks.isValidProductName("12"));
    }

    @Test
    public void isValidProductName_should_return_false_for_length_above_10() {
        assertFalse(starberks.isValidProductName("0123456789a"));
    }

    @Test
    public void readValidProductName_sanity_test() {
        String name = "coffee";
